...
<script type="text/javascript" >
    ...
    function buerge_mail()
    {


        document.getElementById('loader_info_buerge').style.display = 'block';
        var elementStyle = document.getElementById('form_loader_buerge').style;
