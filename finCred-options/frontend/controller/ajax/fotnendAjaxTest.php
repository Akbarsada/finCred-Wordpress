...
<script type="text/javascript" >
    ...
    function test()
    {
/*        document.getElementById('preloader_boni').style.display = 'block';*/
     ...
     /*   elementStyle.border = 'solid';*/
        ...
        var anzahlGarage = jQuery("#input_1_152  option:selected").val();
        ...
        jQuery.ajax({
            ...
            success: function (data) {
               ...
               // window.location.href = 'https://staging.eugen.immo/boni-request/?boni_post_id='+boni_post_id+'&hashtag_objekt='+hashtag_objekt+'&hashtag_kunde='+hashtag_kunde+'&warmmiete='+warmmiete+'&anzahlMieter='+anzahlMieter;

                window.location.href = site_url+'/boni-request/?boni_post_id='+boni_post_id+'&hashtag_objekt='+hashtag_objekt+'&hashtag_kunde='+hashtag_kunde+'&warmmiete='+warmmiete+'&anzahlMieter='+anzahlMieter;
