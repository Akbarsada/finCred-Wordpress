...
function manuell_invite ($boni_post_id, $nummer_hauptmieter, $email  ) {
   ...
   // $email = get_post_meta( $boni_post_id, 'email_hauptmieter_'.$nummer_hauptmieter, true );
    ...
    $finCredInvite_versendet_Key = 'boni_versendet_hauptmieter_'.$nummer_hauptmieter;
    ...
    $link = site_url().'/boni-check-manuell/?boni_post_id='.$boni_post_id.'&nummer_inviter='.$nummer_hauptmieter;
					...
					<td align="center">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="16"></td>
								<td align="center">
									<a class="button_link" href="'.$link.'"><img src="https://staging.eugen.immo/wp-content/plugins/eugen-options/assets/396x96_button_de.png" width="198" height="48" alt="Zur Bonität">Zur Bonität</a>
								</td>
								<td width="16"></td>
							</tr>
							<tr>
...
';
    ...
    wp_mail( $email, '$appartment_titel', $message, $headers );
    update_post_meta( $boni_post_id, 'boni_art_hauptmieter_'.$nummer_hauptmieter,  'm');
